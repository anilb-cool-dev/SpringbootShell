package SpringbootShell.Controller;

import SpringbootShell.Model.PurchaseHistory;
import SpringbootShell.Service.SpringbootShellService;
...
@RestController
public class SpringbootShellController
{
    @Autowired
    private SpringbootShellService service;
